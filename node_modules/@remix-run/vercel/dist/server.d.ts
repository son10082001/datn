...
export declare function createRemixRequest(req: VercelRequest, res: VercelResponse): NodeRequest;
export declare function sendRemixResponse(res: VercelResponse, nodeResponse: NodeResponse): Promise<void>;
