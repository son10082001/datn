...
declare type UseMatches = () => RouteMatch[] | null;
/**
 ...
 */
export declare function withSentry<P extends Record<string, unknown>, R extends React.FC<P>>(OrigApp: R, options?: {
