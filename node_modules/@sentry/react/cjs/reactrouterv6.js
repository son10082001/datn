...
function withSentryReactRouterV6Routing(Routes) {
  ...
  const SentryRoutes = (props) => {
    ...
    return React__default.createElement(Routes, { ...props, __self: this, __source: {fileName: _jsxFileName, lineNumber: 197}} );
  };
  ...
  return (routes, locationArg) => {
    const SentryRoutes = () => {
      ...
      const stableLocationParam =
        typeof locationArg === 'string' || _optionalChain([locationArg, 'optionalAccess', _ => _.pathname]) !== undefined
          ? (locationArg )
          : location;
    ...
    return React__default.createElement(SentryRoutes, {__self: this, __source: {fileName: _jsxFileName, lineNumber: 248}} );
  };
}
